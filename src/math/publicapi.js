...
import AbstractMathQuill from './AbstractMathQuill.js'
import API from './var/API.js'
import $ from './$.js'
import Controller from './controller.js'
import Options from './var/Options.js'
import APIClasses from './var/APIClasses.js'
import optionProcessors from './var/optionProcessors.js'
/*********************************************************
 * The publicly exposed MathQuill API.
 ********************************************************/

var Progenote = P(), EMBEDS = {};
...
export function config(currentOptions, newOptions) {
...
export function getInterface(v) {
  ...
  APIClasses.AbstractMathQuill = P(Progenote, function(_) {
